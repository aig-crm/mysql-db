...
INSERT INTO `cancel_bookings` VALUES (5,'2022-09-08','C-1201','1295','fgbfjhgj','134654567','jhcgj@xfgh','AAZAM','40 30 30','sbi',1254365,1317083,'C','ghfjgh','15435677','chj@ghjhgj',154235,'hggfxh'),(6,'2022-09-08','C-1104','1495','rohan','21345446','ghfc@ghjg','ABHISHEK HLL ASSOCIATES','40 30 30','sbi',7549000,7926450,'C','na','na','na@vhfv',51000,'fraud'),(7,'2022-09-08','C-1104','1495','dgfhfg','145365547','','AAZAM','40 30 30','',213421435,224092507,'C','sfghjghj','6135676','',2134,'fraud'),(8,'2022-09-09','C-1201','1495','gfdhf','1345456365','','AAZAM','40 30 30','',1534652,1611385,'C','shfgdfsd','14355653456','',161138,'fraud');
...
INSERT INTO `documents` VALUES (10,'D-1801','D-1801.pdf','2022-12-16 10:41:11'),(11,'D-1801','payment structure of-D-1801.pdf','2022-12-16 04:40:01'),(12,'D-1801','Inventory Report.csv','2022-12-16 05:25:30');
...
CREATE TABLE `other_charges` (
  ...
  `unit_no` varchar(120) NOT NULL,
  `parameters` varchar(600) NOT NULL,
...
INSERT INTO `other_charges` VALUES ('D-1801[1]','D-1801','ONE TIME LEASE RENT',103600,0,1),('D-1801[10]','D-1801','2 YEARS ADVANCE MAINTENANCE CHARGES',69930,0,10),('D-1801[2]','D-1801','ELECTRICITY METER CHARGES',0,0,2),('D-1801[3]','D-1801','DG POWER BACK-UP ELECTRIC METER CHARGES',11000,0,3),('D-1801[4]','D-1801','ELECTRICAL INFRASTRUCTURE CHARGES AS PER APPOROVED DRAWING BY RESPECTIVE AUTHORITES',35000,0,4),('D-1801[5]','D-1801','CHARGES FOR ADDITIONAL PROVISION OF 1 KVA DG POWER BACKUP FACILITY AS PER UPDATED APPROVE DRAWING BY RESPECTIVE AUTHORITES',25000,0,5),('D-1801[6]','D-1801','WATER & SEWAGE CONNECTION CHARGES ^^',11000,0,6),('D-1801[7]','D-1801','IGL GAS CONNECTION INFRASTRUCTURE DEVELOPMENT CHARGES',1600,0,7),('D-1801[8]','D-1801','CLUB USAGE CHARGES FOR 1 YEAR',10000,0,8),('D-1801[9]','D-1801','INTEREST FREE MAINTENANCE SECURITY (IFMS)',32375,0,9);
...
-- Dump completed on 2022-12-18 22:30:01
